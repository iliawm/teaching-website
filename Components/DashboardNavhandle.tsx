            ...
            <div className={`w-full h-full dashbtn   flex justify-center items-center`} onClick={()=>{
                ...
                {open ?
                    <div className={" rounded-2xl w-full! h-full flex flex-col z-50"}>
                        <button className={"text-4xl font-semibold  h-full flex items-center justify-center cursor-pointer hover:opacity-60"} onClick={()=>{setOpen(false)}}><IoCloseSharp /></button>
