    ...
    return (
        <div className={"w-[20%] h-full flex flex-col bg-white absolute z-30 min-w-42.5 "}>
            ...
            <div className="custom-scrollbar w-full h-75/100 text-xl items-start flex flex-col justify-start p-1 gap-1 bg-white overflow-y-scroll overflow-x-hidden">
                ...
                <Link href={`/users/${id}?section=profile`} className="w-full h-8/100 opacity-95 gap-3 flex items-center justify-start min-h-8.25 hover:bg-gray-400 transition-all duration-1000 ease-linear">
                    <VscAccount className={"text-lg w-10"}/>
                    <div className="w-full flex items-cente justify-start">Profile</div>
                </Link>
                <Link href={`/users/${id}?section=security`} className="w-full h-8/100 opacity-95 gap-3 flex items-center justify-start min-h-8.25 hover:bg-gray-400 transition-all duration-1000 ease-linear">
                    <IoLockOpenOutline className={"text-lg w-10"}/>
                    <div className="w-full flex items-cente justify-start">security</div>
                </Link>
                <Link href={`/users/${id}?section=other`} className="w-full h-8/100 opacity-95 gap-3 flex items-center justify-start min-h-8.25 hover:bg-gray-400 transition-all duration-1000 ease-linear">
                ...
                <Link href={`/users/${id}?section=videos`} className="w-full h-8/100 opacity-95 gap-3 flex items-center justify-start min-h-8.25 hover:bg-gray-400 transition-all duration-1000 ease-linear">
                    <MdVideoSettings className={"text-lg w-10"}/>
                    <div className="w-full flex items-cente justify-start">Videos</div>
                </Link>
                <Link href={`/users/${id}?section=books`} className="w-full h-8/100 opacity-95 gap-3 flex items-center justify-start min-h-8.25 hover:bg-gray-400 transition-all duration-1000 ease-linear">
                    <PiBooks className={"text-lg w-10"}/>
                    <div className="w-full flex items-cente justify-start">Books</div>
                </Link>
                <Link href={`/users/${id}?section=status`} className="w-full h-8/100 opacity-95 gap-3 flex items-center justify-start min-h-8.25 hover:bg-gray-400 transition-all duration-1000 ease-linear">
                ...
                <Link href={`/users/${id}?section=more`} className="w-full h-8/100 opacity-95 gap-3 flex items-center justify-start min-h-8.25 hover:bg-red-600 transition-all duration-1000 ease-linear">
